...
namespace i20022.sese01400102
{
    ...
    /// with id sese.014.001.02 name PEPOrISAOrPortfolioTransferCancellationRequestV02 from Securities Settlement business area.
    /// Repository:R 6.8.0.1 v492 - 4 July 2008
    /// </summary>
    [SerializableAttribute()]
    [DebuggerStepThroughAttribute()]
    [XmlTypeAttribute( Namespace = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.02" )]
    [XmlRootAttribute( Namespace = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.02", IsNullable = false )]
    public class Document
    {

        /// <summary>
        /// Element <b>PEPOrISAOrPrtflTrfCxlReqV02</b> (PEPOr ISAOr Portfolio Transfer Cancellation Request V02) of type PEPOrISAOrPortfolioTransferCancellationRequestV02.
        /// </summary>
    ...
    /// <summary>
    /// Class <b>PEPOrISAOrPortfolioTransferCancellationRequestV02</b> (PEPOr ISAOr Portfolio Transfer Cancellation Request V02).
    /// </summary>
    [SerializableAttribute()]
    [DebuggerStepThroughAttribute()]
    [XmlTypeAttribute( Namespace = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.02" )]
    public class PEPOrISAOrPortfolioTransferCancellationRequestV02
    {
        ...
        /// This element can be:
        ///  CxlByRef of type TransferReference3 
        ///  CxlByTrfInstrDtls of type PEPISATransfer7 
        /// </summary>
        [XmlElementAttribute( "CxlByRef", typeof( TransferReference3 ), Order = 4 )]
        [XmlElementAttribute( "CxlByTrfInstrDtls", typeof( PEPISATransfer7 ), Order = 4 )]
        public object Item;
    }
    ...
    /// <summary>
    /// Class <b>TransferReference4</b> (Transfer Reference 4).
    /// </summary>
    [SerializableAttribute()]
    [DebuggerStepThroughAttribute()]
    [XmlTypeAttribute( Namespace = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.02" )]
    public class TransferReference4
    {
    ...
    /// <summary>
    /// Class <b>TransferReference3</b> (Transfer Reference 3).
    /// </summary>
    [SerializableAttribute()]
    [DebuggerStepThroughAttribute()]
    [XmlTypeAttribute( Namespace = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.02" )]
    public class TransferReference3
    {
        ...
        /// <summary>
        /// Element <b>TrfRefs</b> (Transfer Refs) of type array of TransferReference4.
        /// </summary>
        [XmlElementAttribute( "TrfRefs", Order = 1 )]
    ...
    /// </summary>
    [SerializableAttribute()]
    [XmlTypeAttribute( Namespace = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.02", IncludeInSchema = false )]
    ...
    /// <summary>
    /// Class <b>ISAYearsOfIssue1</b> (ISAYears Of Issue 1).
    /// </summary>
    [SerializableAttribute()]
    [DebuggerStepThroughAttribute()]
    [XmlTypeAttribute( Namespace = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.02" )]
    ...
    /// <summary>
    /// Enumeration <b>ISAType1Code</b> (ISAType 1Code).
    /// </summary>
    [SerializableAttribute()]
    [XmlTypeAttribute( Namespace = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.02" )]
    ...
    /// <summary>
    /// Class <b>PEPISATransfer8</b> (PEPISATransfer 8).
    /// </summary>
    [SerializableAttribute()]
    [DebuggerStepThroughAttribute()]
    [XmlTypeAttribute( Namespace = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.02" )]
    public class PEPISATransfer8
    {
        ...
        /// <summary>
        /// Element <b>RsdlCshInd</b> (Rsdl Cash Indicator) of type bool.
        /// </summary>
        [XmlElementAttribute( Order = 3 )]
        ...
        /// Element <b>Item</b> (Item) of type object.
        /// This element can be:
        ///  ISA of type ISAYearsOfIssue1 
        ///  PEP of type PreviousYearChoice 
        ///  Prtfl of type Portfolio1 
        /// </summary>
        [XmlElementAttribute( "ISA", typeof( ISAYearsOfIssue1 ), Order = 4 )]
        [XmlElementAttribute( "PEP", typeof( PreviousYearChoice ), Order = 4 )]
        [XmlElementAttribute( "Prtfl", typeof( Portfolio1 ), Order = 4 )]
        public object Item;

        /// <summary>
        /// Element <b>FinInstrmAsstForTrf</b> (Financial Instrument Asset For Transfer) of type array of FinancialInstrument11.
        /// </summary>
        [XmlElementAttribute( "FinInstrmAsstForTrf", Order = 5 )]
    ...
    /// <summary>
    /// Class <b>PEPISATransfer7</b> (PEPISATransfer 7).
    /// </summary>
    [SerializableAttribute()]
    [DebuggerStepThroughAttribute()]
    [XmlTypeAttribute( Namespace = "urn:iso:std:iso:20022:tech:xsd:sese.014.001.02" )]
    public class PEPISATransfer7
    {
        ...
        /// </summary>
        [XmlElementAttribute( "OthrIndvInvstr", Order = 2 )]
        ...
        /// </summary>
        [XmlElementAttribute( "OthrCorpInvstr", Order = 5 )]
        ...
        /// <summary>
        /// Element <b>PdctTrf</b> (Product Transfer) of type array of PEPISATransfer8.
        /// </summary>
        [XmlElementAttribute( "PdctTrf", Order = 10 )]
        public PEPISATransfer8[] PdctTrf;

        /// <summary>
        /// Element <b>Xtnsn</b> (Extension) of type array of Extension1.
        /// </summary>
        [XmlElementAttribute( "Xtnsn", Order = 11 )]
